...
for i,target in enumerate(target_list):
    ...
    #os.system('srun -J 15GB-4c --mem 15000 -c 4 -w zirconium python2 /u/whitaker.213/tagger-v/train.py --word_dim=300 --train=dataset/eng.train --dev=dataset/eng.testa --test=dataset/eng.testb --pre_emb=' + target)
    os.system('srun -J 15GB-4c --mem 15000 -c 4 -w zirconium python3 /u/whitaker.213/tagger-v/clean.py ' + target)
